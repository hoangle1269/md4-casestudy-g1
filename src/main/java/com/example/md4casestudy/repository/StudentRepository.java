...
public interface StudentRepository extends JpaRepository<Student, Long> {
    @Query("SELECT new com.example.md4casestudy.model.dto.StudentIdDTO(s.user.fullName, s.user.email, s.studentId) FROM Student s WHERE s.className.classId = :classId")
